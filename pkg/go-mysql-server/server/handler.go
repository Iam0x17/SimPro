...
import (
	...
	"SimPro/pkg/go-mysql-server/internal/sockstate"
	"SimPro/pkg/go-mysql-server/sql"
	"SimPro/pkg/go-mysql-server/sql/analyzer"
	"SimPro/pkg/go-mysql-server/sql/iters"
	"SimPro/pkg/go-mysql-server/sql/plan"
	"SimPro/pkg/go-mysql-server/sql/rowexec"
...
func (h *Handler) NewConnection(c *mysql.Conn) {
	...
	common.Logger.Info(common.EventNewConnection, zap.String("protocol", "mysql"),
...
func (h *Handler) ConnectionClosed(c *mysql.Conn) {
	...
	common.Logger.Info(common.EventCloseConnection, zap.String("protocol", "mysql"),
		zap.String("local", c.Conn.LocalAddr().String()),
		zap.String("remote", c.Conn.RemoteAddr().String()))
}
