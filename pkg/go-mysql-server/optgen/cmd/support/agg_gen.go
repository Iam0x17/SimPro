...
func (g *AggGen) Generate(defines GenDefs, w io.Writer) {
	...
	fmt.Fprintf(g.w, "    \"fmt\"\n")
	fmt.Fprintf(g.w, "    \"SimPro/pkg/go-mysql-server/sql/types\"\n")
	fmt.Fprintf(g.w, "    \"SimPro/pkg/go-mysql-server/sql\"\n")
	fmt.Fprintf(g.w, "    \"SimPro/pkg/go-mysql-server/sql/expression\"\n")
	fmt.Fprintf(g.w, "    \"SimPro/pkg/go-mysql-server/sql/transform\"\n")
	fmt.Fprintf(g.w, ")\n\n")
