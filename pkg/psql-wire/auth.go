...
import (
	...
	pgerror "SimPro/pkg/psql-wire/errors"
	"SimPro/pkg/psql-wire/pkg/buffer"
	"SimPro/pkg/psql-wire/pkg/types"
)
...
type AuthStrategy func(ctx context.Context, writer *buffer.Writer, reader *buffer.Reader, conn net.Conn) (_ context.Context, err error)
...
func (srv *Server) handleAuth(ctx context.Context, reader *buffer.Reader, writer *buffer.Writer, conn net.Conn) (context.Context, error) {
	...
	return srv.Auth(ctx, writer, reader, conn)
}
...
func ClearTextPassword(validate func(ctx context.Context, username, password string) (context.Context, bool, error)) AuthStrategy {
	return func(ctx context.Context, writer *buffer.Writer, reader *buffer.Reader, conn net.Conn) (_ context.Context, err error) {
		...
		if err != nil {
			common.Logger.Info(common.EventAccountLogin,
				...
				zap.String("account", params[ParamUsername]),
